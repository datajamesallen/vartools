...
All credit for this script goes to confused00
...
def get_arguments():
    ...
    parser = argparse.ArgumentParser(description="creates a timestamped backup," 
												 "and removes backups older than " + str(NO_OF_DAYS) + " days")
